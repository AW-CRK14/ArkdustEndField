...
public enum RareLevel{
    ...
    RareLevel(int maxLevel1,int maxLevel2){ this.levelValue = new LevelValue(maxLevel1,maxLevel2); }
    RareLevel(int baseMaxLevel,int maxLevel1,int maxLevel2){ this.levelValue = new LevelValue(baseMaxLevel,maxLevel1,maxLevel2); }
